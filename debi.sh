...
install='systemd libpam-systemd apt-transport-https iproute2 procps coreutils bash-completion net-tools util-linux tar grep sudo wget curl ca-certificates vim xz-utils unzip'
upgrade=
kernel_params=
force_lowmem=
bbr=false
